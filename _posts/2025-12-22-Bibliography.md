...
I will pinpoint in this section all the documentations that have been used to write my kind of technical writeup, it's only to keep track of all the things in case i forget, and it can also be helpful later on for crossing references between them.
